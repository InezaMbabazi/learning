...
# Canvas and OpenAI API keys
API_TOKEN = '1941~tNNratnXzJzMM9N6KDmxV9XMC6rUtBHY2w2K7c299HkkHXGxtWEYWUQVkwch9CAH'  # Insert your actual Canvas API token here
BASE_URL = 'https://kepler.instructure.com/api/v1'
openai.api_key = "YOUR_OPENAI_API_KEY"  # Insert your actual OpenAI API key here
...
# Canvas API interaction functions
...
def submit_feedback(course_id, assignment_id, user_id, feedback):
    ...
    if response.status_code in [200, 201]:
        ...
        st.write("Response Text:", response.text)
        return False, f"Failed to submit feedback for user ID {user_id}."
