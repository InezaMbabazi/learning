...
def generate_grading_feedback(submission_text, proposed_answer):
    ...
    # Prompt for OpenAI to provide alignment feedback and improvements
    prompt = (
        f"Evaluate the following student's submission against the proposed answer. "
        f"Assess alignment and rate it from 0 to 100. If no alignment is found, specify 'no alignment' "
        f"and don't give a grade. Additionally, suggest areas for improvement if needed.\n\n"
