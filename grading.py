...
def detect_ai_generated_content(student_submission):
    detection_prompt = f"Determine if the following content is likely generated by AI:\n\n{student_submission}\n"
    ...
    detection_feedback = response['choices'][0]['message']['content']
...
st.markdown("""
    <div style="background-color: #f0f0f5; padding: 20px; border-radius: 10px; margin-bottom: 20px;">
        ...
        <ul style="list-style-type: square;">
            ...
            <li>Submit to receive grading and feedback for all submissions, along with AI-generated content detection.</li>
        </ul>
...
if uploaded_files and proposed_answer:
    ...
    for uploaded_file in uploaded_files:
        try:
            ...
            # Detect if the submission is AI-generated
            ai_detection = detect_ai_generated_content(student_submission.strip())
