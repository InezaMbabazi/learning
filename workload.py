...
if st.session_state.get("reassignment_applied_flag", False):
    if st.session_state.get("reassignment_ready_to_rerun", False):
        st.session_state.reassignment_applied_flag = False
        st.session_state.reassignment_ready_to_rerun = False
        st.experimental_rerun()
    else:
        st.session_state.reassignment_ready_to_rerun = True
...
# During reassignment (inside the button block):
# st.session_state.assignments = updated_df
# st.session_state.reassignment_applied_flag = True
# st.session_state.reassignment_ready_to_rerun = False

# When generating assignments initially, use:
# if not st.session_state.reassignment_applied:
#     result_df, lecturer_hours, lecturer_limits = generate_workload_assignment(...)
