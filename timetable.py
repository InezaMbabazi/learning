...
def generate_timetable(course_df, room_df, selected_days):
    ...
    # Total weekly hours calculation for courses
    total_course_hours = 0
    for _, row in course_df.iterrows():
        sections = row['section']
        total_course_hours += sections * 4  # 4 hours per section per week
    ...
    room_hour_shortage = total_course_hours - total_room_hours
    ...
    return timetable, teacher_stats, room_shortages, hour_shortages, unused_rooms, total_course_hours, total_room_hours, room_hour_shortage

# Function to display timetable in a weekly format
def display_timetable(timetable, teacher_stats, room_shortages, hour_shortages, unused_rooms, total_course_hours, total_room_hours, room_hour_shortage):
...
def main():
    ...
    if course_file and room_file:
        ...
        timetable, teacher_stats, room_shortages, hour_shortages, unused_rooms, total_course_hours, total_room_hours, room_hour_shortage = generate_timetable(course_df, room_df, selected_days)
        
        # Display timetable and summary
        display_timetable(timetable, teacher_stats, room_shortages, hour_shortages, unused_rooms, total_course_hours, total_room_hours, room_hour_shortage)
